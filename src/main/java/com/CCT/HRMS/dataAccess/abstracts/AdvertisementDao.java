...
public interface AdvertisementDao extends JpaRepository<Advertisement, Integer> {
	...
	@Query("From Advertisement where employer_id=:id") // annotation declares finder queries directly on repository methods
	...
	Page<Advertisement> getByJobTitleContainsIgnoreCaseAndWorkTime_Id(String jobTitle, int workTimeId,
			Pageable pageable);
