...
public interface AdvertisementService {
    ...
    DataResult<List<Advertisement>> getJobAdsByJobTitleAndLocation(String jobTitle, int locationId,int pageNo, int pageSize);
    
    DataResult<List<Advertisement>> getJobAdsByJobTitleAndLocationAndWorkTime(String jobTitle, int locationId,int workTimeId,int pageNo, int pageSize);

    DataResult<List<Advertisement>> getJobAdsByLocationAndWorkTime(int locationId,int workTimeId,int pageNo, int pageSize);

    DataResult<List<Advertisement>> getJobAdsByJobTitleAndWorkTime(String jobTitle,int workTimeId,int pageNo, int pageSize);
